"""
aria/channels/telegram/bot.py — Telegram bot interface (the built-in "telegram"
channel plugin's receive loop; legacy alias: aria.telegram_bot).
...
async def _reply(update: Update, text: str, parse_html: bool = True) -> None:
    ...
    from aria.channels.telegram.notify import _md_to_html
